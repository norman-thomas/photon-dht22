...
void publish(const Environment& env) {
    ...
    String json_condition = "{ \"temperature\": " + String(env.temperature) + ", \"humidity\": " + String(env.humidity) + ", \"dewPoint\":" + String(env.dewPoint) + ", \"dewPointSlow\":" + String(env.dewPointSlow) + " }";
